...
- **chunking_method** (optional): Type of chunking technique that will be used (simple as default). Each chunking method has different parameters associated:
  - **simple** 
  - **recursive:**
    - **sub_window_length**: Integer value to specify the window length for the sub-chunks.
    - **sub_window_overlap**: Integer value to specify the window overlap for the sub-chunks.
  - **surrounding_context_window:**
    - **windows:** Number of the windows that will be taken in this method
