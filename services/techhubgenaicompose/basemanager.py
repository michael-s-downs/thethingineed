...
class AbstractManager(ABC):
    ...
    def raise_GenaiError(self, status_code, message):
        ...
        Raises:
            GenaiError
        """
        raise GenaiError(status_code=status_code, message=message)

    def raise_PrintableGenaiError(self, status_code, message):
        """Raises PrintableGenaierror with a specific status_code and message.
        ...
        Raises:
            GenaiError
        """
        raise PrintableGenaiError(status_code=status_code, message=message)
