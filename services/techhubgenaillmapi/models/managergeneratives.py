...
from models.geminimodel import ChatGemini, ChatGeminiVision
from common.models_manager import BaseModelConfigManager
from generatives import GenerativeModel


class ManagerModel(object):
    MODEL_TYPES = [ChatGPTModel, ChatClaudeModel, DalleModel, ChatClaudeVision, ChatGPTVision, LlamaModel, ChatNova, ChatNovaVision, ChatGPTOModel, ChatGPTOVisionModel, ChatGemini, ChatGeminiVision]
